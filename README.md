...
```bash
git clone https://github.com/datascience-course/2023-datascience-lectures
```

This will create a folder `2023-datascience-lectures` on your computer, with the individual labs in subdirectories.

## Updating

As we release new lectures or update lectures, you'll have to update your repository. You can do this by changing into the `2023-datascience-lectures` directory and executing:
